...
class ChannelMonitor(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.monitored_channels: Dict[int, dict] = {}  # {channel_id: {mj_user_id, message_id, participants}}
    ...
    def setup_google_sheets(self):
        ...
        try:
            ...
            try:
                ...
                self.sheet.append_row(["channel_id", "mj_user_id", "message_id", "participant_1", "participant_2", "participant_3", "participant_4", "participant_5", "participant_6", "added_at"])
