...
class TradeRequestView(discord.ui.View):
    ...
    async def accept_trade(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Créer la vue de confirmation d'échange avec affichage des cartes
        view = TradeConfirmationView(self.cog, self.initiator, self.target)

        # Créer l'embed de confirmation pour le destinataire
        embed = self._create_trade_confirmation_embed(
    ...
    def _create_trade_confirmation_embed(self, initiator, target, initiator_vault, target_vault, description):
        """Crée un embed de confirmation d'échange."""
        embed = discord.Embed(
